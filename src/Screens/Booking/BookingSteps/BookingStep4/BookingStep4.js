...
class BookingStep4 extends React.Component {
  ...
  handleSubmit = async () => {
    ...
    await axios
      .post(
        `http://localhost:8080/api/booking/addBooking`,
        this.state.booking,
        {
          ...
          <MDBRow>
            ...
            <MDBCol md="4" style={{ padding: "2rem" }}>
              <div className="left-container">
                ...
                <p style={{ fontSize: "0.9rem" }}>
                  {detail.bookingDetails.bookingD.pickUpDate},{" "}
                  {detail.bookingDetails.bookingD.pickUpTime}{" "}
                </p>
                <hr />
                <p
                  className="grey-text"
                ...
                <p style={{ fontSize: "0.9rem" }}>
                  {detail.bookingDetails.bookingD.returnDate},{" "}
                  {detail.bookingDetails.bookingD.returnTime}
                </p>
                <hr />
                <p
                  className="grey-text"
                ...
                <p style={{ fontSize: "0.9rem" }}>
                  {detail.bookingDetails.timePeriod}
                </p>
              </div>
            </MDBCol>
            <MDBCol md="4" style={{ padding: "2rem" }}>
              ...
              <div className="left-container">
                ...
                {equipmentList.map((equipment) => (
                  <p style={{ fontSize: "0.9rem" }}>
                    {equipment.count} x {equipment.name} - £ {equipment.price}
                  </p>
                ))}
              </div>
